...
gestures = {"testdata\\Call_Me":"Call_Me",
            "testdata\\Close":"Close",
            "testdata\\OK":"OK",
            "testdata\\Open":"Open",
            "testdata\\Peace":"Peace",
            "testdata\\Pointing_Up":"Pointing_Up",
            "testdata\\Rock":"Rock",
            "testdata\\Smile":"Smile",
            "testdata\\Thumbs_Down":"Thumbs_Down",
            "testdata\\Thumbs_Up":"Thumbs_Up"}

global rezultati, correct_all, wrong_all
rezultati = {}
correct_all = 0
wrong_all = 0
...
def main():
    ...
    for folder_path, gesture_name in gestures.items():
        ...
        for filename in image_files:
            if filename.lower().endswith(('.png', '.jpg', '.jpeg')):
                ...
                info_gesture = handedness.classification[0].label[0:]
                if keypoint_classifier_labels[hand_sign_id] == gesture_name:
                    correct += 1
                    correct_all += 1
                else:
                    wrong += 1
        ...
        rezultati.update({gesture_name: (correct, wrong)})
