...
gestures = {"videodata\\Pointing_Up":"Pointing_Up",
            "videodata\\Open":"Open",
            "videodata\\Close":"Close",
            "videodata\\Thumbs_Up":"Thumbs_Up",
            "videodata\\Thumbs_Down":"Thumbs_Down",
            "videodata\\Peace":"Peace",
            "videodata\\Rock":"Rock",
            "videodata\\OK":"OK",
            "videodata\\Call_Me":"Call_Me",
            "videodata\\Smile":"Smile"}


global rezultati, correct_all, wrong_all, one_frame
rezultati = {}
correct_all = 0
wrong_all = 0
one_frame = 0
    ...
    for folder_path, gesture_name in gestures.items():
        ...
        for filename in image_files:
            if filename.lower().endswith(('.png', '.jpg', '.jpeg')):
                ...
                if keypoint_classifier_labels[hand_sign_id] == gesture_name and one_frame <= 1:
                    correct += 1
                    correct_all += 1
                elif one_frame > 1:
                    continue
